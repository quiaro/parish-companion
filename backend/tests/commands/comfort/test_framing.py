...
_PASSAGE = RetrievedPassage(reference="Psalm 23:4", verse_text="Test verse text.", is_fallback=False)
...
class TestFramePassage:
    ...
    async def test_returns_the_reflection_text(self, monkeypatch) -> None:
        ...
        reflection = await framing.frame_passage("I'm scared", _PASSAGE, "en")
    ...
    async def test_requests_spanish_when_session_language_is_spanish(self, monkeypatch) -> None:
        ...
        await framing.frame_passage("Tengo miedo", _PASSAGE, "es")
