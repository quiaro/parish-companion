...
| `/schedules` or `/horarios`      | View Mass, Confession, and Office Hours times, including any active or upcoming special schedule |
...
Contributions are welcome. We encourage developers, pastors, theologians, ministry leaders, and parish volunteers to collaborate in improving the project while remaining faithful to its mission.

- **Deploying Parish Companion for your parish?** See [DEPLOYMENT.md](DEPLOYMENT.md) for spreadsheet setup, configuration, and how to connect a custom data source.
- **Contributing to the project?** See [DEVELOPMENT.md](DEVELOPMENT.md) for local setup, running tests, and dev tooling.
